...
TableView::TableView(const TableStyle& style)
	:
	style(style),
	offset(0)
{
...
void TableView::AddRow(const TableRowStyle& style)
{
...
void TableView::OnButtonDown(int x, int y)
{
	float ty = 0.0f;
...
void TableView::OnScroll(int x, int y, int w)
{
...
void TableView::OnKeyDown(sf::Keyboard::Key key)
{
	switch (key) {
